...
from Task2_image_inpainting.lama.saicinpainting.evaluation.masks.mask import SegmentationMask
from Task2_image_inpainting.lama.saicinpainting.utils import LinearRamp
